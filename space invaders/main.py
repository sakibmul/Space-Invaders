...
class Ship:
    ...
    def draw(self, window):
        #pygame.draw.rect(window, (255, 0, 0), (self.x, self.y, 50, 50)) (practice rectangle)
...
# Enemy ship initialisation inherited from Ship class
class Enemy(Ship):
    COLOR_MAP = {
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("YOU LOST, GAME OVER!!", 1, (255, 255, 255))
